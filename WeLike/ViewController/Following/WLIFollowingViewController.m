...
- (void)reloadData {
    ...
    loading = YES;
    NSUInteger page = (self.following.count / kDefaultPageSize) + 1;
    [sharedConnect followingForUserID:self.user.userID page:(int)page pageSize:kDefaultPageSize onCompletion:^(NSMutableArray *following, ServerResponse serverResponseCode) {
        loading = NO;
