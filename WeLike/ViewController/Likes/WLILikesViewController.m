...
- (void)reloadData {
    ...
    loading = YES;
    NSUInteger page = (self.likes.count / kDefaultPageSize) + 1;
    [sharedConnect likesForPostID:self.post.postID page:(int)page pageSize:kDefaultPageSize onCompletion:^(NSMutableArray *likes, ServerResponse serverResponseCode) {
        loading = NO;
